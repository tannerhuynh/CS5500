...
/**
 * Class for creating singleton train tickets to a specific location.
 *
 * @author tannerhuynh
 * @version 1.0.2
 * @since 10-07-2019
 */
public class TrainTicketSingleton extends AbstractTicket {
   ...
   */
  private TrainTicketSingleton(String passenger,
                              String routeID,
  ...
  /**
   * Creates a single instance of a train ticket for a specific location.
   *
   * @param passenger passenger name in string format.
   * @param routeID unique identification for the route in string format.
   * @param departureDateTime Calendar object representing the date and time of departure.
   ...
   */
  public static TrainTicketSingleton createSingleton(String passenger,
                                                           String routeID,
                                                           Calendar departureDateTime,
                                                           Calendar arrivalDateTime,
                                                           Locations departureLocation,
    ...
    if (!tripsCompleted.isEmpty()) {
      ...
      return new TrainTicketSingleton(passenger,
              routeID,
              departureDateTime,
              arrivalDateTime,
              departureLocation,
