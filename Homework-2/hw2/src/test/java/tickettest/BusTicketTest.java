...
public class BusTicketTest {
  ...
  public void setTripDates() {
    ...
    assertEquals("Sat Dec 21 15:18:00 " + busTicket3.getArrivalDateAndTime()
            .getTimeZone().getDisplayName(false,
            TimeZone.SHORT) + " 2019", busTicket3.getArrivalDateAndTime().getTime().toString());
    assertEquals("Thu Dec 19 05:15:00 " + busTicket3.getDepartureDateAndTime()
            .getTimeZone().getDisplayName(false,
            TimeZone.SHORT) + " 2019", busTicket3.getDepartureDateAndTime().getTime().toString());
  }
  ...
  public void createBusTicket() {
    factory.BusTicket busTicket5 = new factory.BusTicket("Dave Campbell", "ID23673",
            departure1, arrival1, factory.Locations.BOS,
            factory.Locations.ATL, null);
    factory.BusTicket busTicket6 = new factory.BusTicket("Mary Mae", "ID1278",
            departure2, arrival2, factory.Locations.LAX,
            factory.Locations.SFO, null);
