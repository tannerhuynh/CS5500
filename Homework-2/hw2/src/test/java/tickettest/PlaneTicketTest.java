...
public class PlaneTicketTest {
  ...
  public void createPlaneTicket() {
    factory.PlaneTicket planeTicket5 = new factory.PlaneTicket("Dave Campbell", "ID23673",
            departure1, arrival1, factory.Locations.BOS,
            factory.Locations.ATL, factory.ClassOfService.FIRST_CLASS);
    factory.PlaneTicket planeTicket6 = new factory.PlaneTicket("Mary Mae", "ID1278",
    ...
    assertEquals(factory.ClassOfService.FIRST_CLASS, planeTicket5.getClassOfService());
    ...
    assertEquals(factory.ClassOfService.BUSINESS, planeTicket6.getClassOfService());
  }
}