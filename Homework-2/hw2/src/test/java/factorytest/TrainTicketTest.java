...
public class TrainTicketTest {
  ...
  public void createTrainTicket() {
    TrainTicket trainTicket5 = new TrainTicket("Dave Campbell", "ID23673",
            departure1, arrival1, Locations.BOS,
            Locations.ATL, ClassOfService.FIRST_CLASS);
    TrainTicket trainTicket6 = new TrainTicket("Mary Mae", "ID1278",
            departure2, arrival2, Locations.LAX,
            Locations.SFO, ClassOfService.BUSINESS);
    ...
    assertEquals(ClassOfService.FIRST_CLASS, trainTicket5.getClassOfService());
    ...
    assertEquals(ClassOfService.BUSINESS, trainTicket6.getClassOfService());
  }
}